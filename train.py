...
WINDOW_PATTERN = "L"    # full attention every layer (more efficient on non-H100)

# Optimization
TOTAL_BATCH_SIZE = 2**17 # ~131K tokens per optimizer step (reduced for 16GB VRAM)
...
DEVICE_BATCH_SIZE = 32   # per-device batch size (sized for 16GB VRAM)
...
GPU_BF16_PEAK_FLOPS = 175.76e12  # RTX 5070 Ti BF16 w/ sparsity
